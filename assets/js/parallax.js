...
var parallaxPage = function(name, pageHtml){
	return{
		key: name,
		page : pageHtml,
		right  : function(callback){return this.transition({left:parallax.width,top:200}  ,{left:-parallax.width,top:200} ,callback);},
		left   : function(callback){return this.transition({left:-parallax.width,top:200} ,{left:parallax.width,top:200}  ,callback);},
		...
		transition : function(locationNew, locationOld, callback){
			if(!parallax.sliding){
				...
				if(parallax.current !== this){
					...
					this.slide({left:0,top:200}, function(){
		...
		show : function(newLocation){
			newLocation = newLocation || {left:0,top:200}; //defaults on screen
			if(typeof parallax.current !== 'undefined'){
